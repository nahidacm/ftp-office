...
$body .= "First Name: ".$_REQUEST['user_name']."<br />";
$body .= "Last Name: ".$_REQUEST['user_lname']."<br />";
...
if ($_REQUEST['user_name'] != '' && $_REQUEST['user_lname']!='' && $_REQUEST['user_email']!=''){
	...
	$sql = "INSERT INTO ".$prefix."rem_rent_request VALUES ('', '".$_REQUEST['fk_houseid']."', '0000-00-00', '', '0000-00-00 00:00:00', '0', '0000-00-00 00:00:00', '".$_REQUEST['user_name']."', '".$_REQUEST['user_lname']."', '".$_REQUEST['user_email']."', '".$_REQUEST['chkProperty']."', '".$_REQUEST['chkMaintence']."', '".$_REQUEST['chkComparable']."', '', '0')";
	mysql_query( $sql);	
