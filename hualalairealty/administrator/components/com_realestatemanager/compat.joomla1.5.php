...
if(!defined('_REAL_ESTATE_MANAGER_COMPAT_FILE_LOADED'))
      {
       
        define( '_REAL_ESTATE_MANAGER_COMPAT_FILE_LOADED', 1 );
	...
	if( class_exists('JConfig'))
		...
		// TODO: determine what else is needed to work without the legacy plugin
             ...
             include_once($mosConfig_absolute_path."/administrator/components/com_realestatemanager/functions.php");
                  
        
              
                  if( !class_exists('mosHTML'))
                  {     
                   include_once($mosConfig_absolute_path."/administrator/components/com_realestatemanager/includes/html.php");
                  }
              
                 if( !class_exists('category'))
                  {
                   include_once($mosConfig_absolute_path."/administrator/components/com_realestatemanager/includes/category.php");
                  }
       
                        
              if( !class_exists('mosAdminMenus'))
              {
               include_once($mosConfig_absolute_path."/administrator/components/com_realestatemanager/includes/adminmenus.php");  
              }

                     
          if( !class_exists('mosTabs'))
          {
           include_once($mosConfig_absolute_path."/administrator/components/com_realestatemanager/includes/classes.php");      

          }
          
          if( !class_exists('mosMenu'))
          {
           include_once($mosConfig_absolute_path."/administrator/components/com_realestatemanager/includes/menu.php");      
          }             
          if( !class_exists('mosParameters'))
          {
           include_once($mosConfig_absolute_path."/administrator/components/com_realestatemanager/includes/parameters.php");      
          }                 
       if( !class_exists('mosMambotHandler'))
       {
        include_once($mosConfig_absolute_path."/administrator/components/com_realestatemanager/includes/mambothandler.php");      
       }   
