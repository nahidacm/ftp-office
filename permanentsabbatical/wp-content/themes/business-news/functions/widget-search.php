...
class search_links_Widget extends WP_Widget {
	...
	function search_links_Widget() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'search_links-widget', 'WLM - Search', $widget_ops, $control_ops );
	}
...
?>	
	<div class="block_newsletter">
		<form action="/" method="get" class="search">
			<div class="field"><input type="text" name="s" id="s" class="shadow_inset" value="<?php _e('Search...', 'goodminimal'); ?>" onblur="if (this.value == ''){this.value = '<?php _e('Search...', 'goodminimal'); ?>'; }" onfocus="if (this.value == '<?php _e('Search...', 'goodminimal'); ?>') {this.value = '';}" /></div>
			<input type="submit" class="button" value="<?php _e('Search','weblionmedia'); ?>">
