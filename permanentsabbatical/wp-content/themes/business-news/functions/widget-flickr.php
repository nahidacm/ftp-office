...
class flickr_Widget extends WP_Widget {
	...
	function flickr_Widget() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'flickr-widget', 'WLM - Flickr', $widget_ops, $control_ops );
	}
...
<?php
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => '', 'description' => 'Last flickr photos' );
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'flickr_username' ); ?>"><?php echo 'Flickr ID (<a href="http://www.idgettr.com" target="_blank">idGettr</a>):'; ?></label>
