...
<script type="text/javascript">
	function updateCategory(e){
		...
		if(e.value == '4'){
			...
			jQuery('#lease_renegotiate_date').show('');
			jQuery('#lease_expiration_date').show('');
			jQuery('#lease_rent').show('');
			jQuery('#pur_price_fee').show('');
...
$sessId = session_id();
?>
<link href="<?php echo site_url();?>/wp-admin/multiplefileupload/css/style.css" rel="stylesheet" type="text/css">
<script src="<?php echo site_url();?>/wp-admin/multiplefileupload/js/swfupload.js" type="text/javascript"></script>
<script src="<?php echo site_url();?>/wp-admin/multiplefileupload/js/swfupload.queue.js" type="text/javascript"></script>
<script src="<?php echo site_url();?>/wp-admin/multiplefileupload/js/fileprogress.js" type="text/javascript"></script>
<script src="<?php echo site_url();?>/wp-admin/multiplefileupload/js/handlers.js" type="text/javascript"></script>
<script type="text/javascript">
		...
		window.onload = function() {
			var settings = {
				...
				flash_url : "<?php echo site_url();?>/wp-admin/multiplefileupload/swf/swfupload.swf",
				flash9_url : "<?php echo site_url();?>/wp-admin/multiplefileupload/swf/swfupload_fp9.swf",
				upload_url: "uploadmultiple.php",
				post_params: {"PHPSESSID" : "<?php echo $sessId; ?>"},
				file_size_limit : "1024 MB",
				file_types : "*.txt;*.doc;*.docx;*.odt;*.rtf;*.ppt;*.pdf;*.jpg;*.jpeg;*.gif;*.png;*.tiff;*.svg;*.zip;*.dgl;*.idd;*.qxp;*.qxd;*.psd;*.7a;*.rar;*.sit;*.sitx;*.bmp;*.pptx;*.xls;*.xlsx;*.eps",
				...
				// Button settings
				button_image_url: "<?php echo site_url();?>/wp-admin/multiplefileupload/images/XPButtonUploadText_61x22.png",
				button_width: "61",
				button_height: "22",
...
<?php }?>
<form name="property" id="property" action="property.php" method="post" id="property" enctype="multipart/form-data" onsubmit="return chkValid(this);">
...
<div id="titlewrap">
    ...
    <select onchange="if(this.value == '3'){ jQuery('#pro1').show() ; jQuery('#pro2').show(); jQuery('#pro3').show();} else {jQuery('#pro1').hide() ; jQuery('#pro2').hide(); jQuery('#pro3').hide();};" tabindex="21" style="width:185px;margin-left:200px;" class="Input01" name="property_type" id="property_type">
...
<div id="pro1" <?php if($propertyData[0]->property_type == 3) echo ''; else echo 'style="display:none"'; ?>>
...
<div id="pro2" <?php if($propertyData[0]->property_type == 3) echo ''; else echo 'style="display:none"'; ?>>
...
<div id="pro3" <?php if($propertyData[0]->property_type == 3) echo ''; else echo 'style="display:none"'; ?>>
...
<div id="finishings" <?php if ($propertyData[0]->pro_category == 3) echo ''; else echo 'style="display:none"';  ?>>
	<label class="" id="title-prompt-text" for="title" style="font-size:16px;">Finishes: </label>
...
<div id="tenure" <?php if ($propertyData[0]->pro_category == 3 || $propertyData[0]->pro_category == 4) echo 'style="display:none"'; else echo 'style=""';  ?>>
    ...
    <select onchange="if(this.value == '2'){ jQuery('#pur_price_fee').show();jQuery('#lease_rent').show('#lease_renegotiate_date');jQuery().show();jQuery('#lease_expiration_date').show(); } else { jQuery('#pur_price_fee').hide();jQuery('#lease_rent').hide();jQuery('#lease_renegotiate_date').hide();jQuery('#lease_expiration_date').hide(); }" id="tenure_val" tabindex="52" style="width:185px;margin-left:200px;" class="Input01" name="tenure">
...
<div id="pur_price_fee" <?php if(($propertyData[0]->pro_category != '3' && $propertyData[0]->tenure==2) || ($propertyData[0]->pro_category == '4')) echo ''; else echo 'style="display:none"';?>>
...
<div id="lease_rent" <?php if(($propertyData[0]->pro_category != '3' && $propertyData[0]->tenure==2) || ($propertyData[0]->pro_category == '4')) echo ''; else echo 'style="display:none"';?>>
...
<div id="lease_renegotiate_date" <?php if(($propertyData[0]->pro_category != '3' && $propertyData[0]->tenure==2) || ($propertyData[0]->pro_category == '4')) echo ''; else echo 'style="display:none"';?>>
	<?php
...
<div id="lease_expiration_date" <?php if(($propertyData[0]->pro_category != '3' && $propertyData[0]->tenure==2) || ($propertyData[0]->pro_category == '4')) echo ''; else echo 'style="display:none"';?>>
	<?php	
...
<div id="titlewrap">
	...
	?>
    <div style="width:580px; margin-bottom:20px; margin-left: 200px;">                
        <div class="fieldset flash" id="fsUploadProgress">
        <span class="legend">Upload Queue</span>
        </div>
        <div style="font-weight:bold;">[ The images in the Upload Queue will be uploaded once you click on the Save button above ]</div><br />
        <div id="divStatus">0 Files Uploaded</div>
        <!--<span style="font-size:12px;">&nbsp;&nbsp;&nbsp;Width: 600px, Height: 500 px</span><br /> --><br />    
        <div>
            <span id="spanButtonPlaceHolder"></span>
            <input id="btnCancel" type="button" value="Cancel All Uploads" onClick="swfu.cancelQueue();" disabled="disabled" style="margin-left: 2px;height:23px;margin-top:4px;" />
            <div style="clear:both;"></div>  
        </div> 
        <div style="clear:both;"></div>  
    </div>
    ...
    <?php }else{?>
    <div style="margin-left: 200px; width:580px;"><span style="font-size:12px; font-weight:bold;">You can only upload property images in the Edit mode. Please save this property first, once you have saved it, you can start uploading images.</span></div>
    <?php }?>
</div>
